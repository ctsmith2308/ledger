  ...
  tradeoffs: [
    {
      ...
      con: 'Head-based sampling means some errors in unsampled traces are never exported. True "always capture errors" requires tail-based sampling via an OpenTelemetry Collector, which is added infrastructure.',
    },
    {
